...
public class Practice05ComposeShaderView extends View {
...

    {
        ...
        @SuppressLint("DrawAllocation") Bitmap bitmap1= BitmapFactory.decodeResource(getResources(), R.drawable.batman);
        @SuppressLint("DrawAllocation") Bitmap bitmap2=BitmapFactory.decodeResource(getResources(),R.drawable.batman_logo);
        Shader shader1=new  BitmapShader(bitmap1,Shader.TileMode.CLAMP,Shader.TileMode.CLAMP);
        Shader shader2=new BitmapShader(bitmap2,Shader.TileMode.CLAMP, Shader.TileMode.CLAMP);
        Shader comShader=new  ComposeShader(shader1,shader2, PorterDuff.Mode.SRC_OVER);
